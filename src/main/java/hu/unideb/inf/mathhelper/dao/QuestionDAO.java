...
import hu.unideb.inf.mathhelper.model.xml.Question;
...
public interface QuestionDAO {
     ...
     * @return a list of {@link hu.unideb.inf.mathhelper.model.xml.Question} pairs.
     ...
     * the questions.
     * @param path a string referring the folder where the files will be looked for.
     * @return a {@link Map} of String and {@link List} of {@link hu.unideb.inf.mathhelper.model.xml.Question} pairs.
     * @throws QuestionFileNotFoundException when there is no question file int the given folder.
     */
     ...
     * @return a list of {@link hu.unideb.inf.mathhelper.model.xml.Question}.
